...
> **Status: `0.6.0-beta`** — published on [NuGet](https://www.nuget.org/packages/AvaloniaRichEditor).
> The public API is stabilizing. The remaining gates before a stable `1.0` are verification depth
> (render pixel tests, cross-platform functional checks, large-document performance), not features — see
