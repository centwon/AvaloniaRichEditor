...
namespace AvaloniaRichTextBox.Demo.Views;
...
public partial class MainWindow : Window
{
    ...
    protected override void OnOpened(System.EventArgs e)
    {
        ...
        this.FindControl<CustomRichTextBox>("RichTextBox")?.FocusDocumentEnd();
    }
    ...
    private async void SaveButton_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        if (file != null)
        {
            string json = AvaloniaRichTextBox.Formatters.DocumentSerializer.Serialize(richTextBox.Document);
    ...
    private async void LoadButton_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        if (file != null && file.Count > 0)
        {
            try
            {
                ...
                if (richTextBox != null)
                {
                    richTextBox.Document = AvaloniaRichTextBox.Formatters.DocumentSerializer.Deserialize(json);
    ...
    private async void ExportHtmlButton_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        if (file != null)
        {
            string html = AvaloniaRichTextBox.Formatters.HtmlDocumentFormatter.ToHtml(richTextBox.Document);
            using var stream = await file.OpenWriteAsync();
            using var writer = new System.IO.StreamWriter(stream);
